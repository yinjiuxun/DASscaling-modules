...
def save_good_events_from_linear_regression(good_event_id, output_filename):
    with open(output_filename, 'w') as outfile:
        json.dump(good_event_id, outfile)


def load_good_events_from_linear_regression(output_filename):
    with open(output_filename, 'r') as infile:
        good_event_id = json.load(infile)
    return good_event_id
